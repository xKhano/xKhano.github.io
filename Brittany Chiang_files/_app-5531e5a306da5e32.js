(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [888],
    {
        ...
        8490: function (t, e, i) {
                ...
                constructor(t, e = {}) {
                    (this.version = "10.12.5"),
                        ...
                        (this.updateAndNotify = (t, e = !0) => {
                            ...
                            this.lastUpdated !== n && ((this.timeDelta = i), (this.lastUpdated = n), b.postRender(this.scheduleVelocityCheck)),
            ...
            let tP = (t) => ({ test: (e) => tx(e) && e.endsWith(t) && 1 === e.split(" ").length, parse: parseFloat, transform: (e) => `${e}${t}` }),
                tb = tP("deg"),
                tw = tP("%"),
                tT = tP("px"),
                tA = tP("vh"),
            ...
            function tM(t, e, i, n) {
                ...
                if (
                    (!e.transform &&
                        (l || n
                            ? (r.transform = (function (t, { enableHardwareAcceleration: e = !0, allowTransformNone: i = !0 }, n, r) {
                                  let s = "";
                                  for (let e = 0; e < to; e++) {
                                      let i = te[e];
                                      if (void 0 !== t[i]) {
            ...
            function tR(t, e, i) {
                ...
                return (
                    t.drag && !1 !== t.dragListener && ((n.draggable = !1), (r.userSelect = r.WebkitUserSelect = r.WebkitTouchCallout = "none"), (r.touchAction = !0 === t.drag ? "none" : `pan-${"x" === t.drag ? "y" : "x"}`)),
            ...
            function tW(t, e, i, n) {
                let r = (0, a.useMemo)(() => {
                    let i = tU();
                    return tN(i, e, { enableHardwareAcceleration: !1 }, t$(n), t.transformTemplate), { ...i.attrs, style: { ...i.style } };
                }, [e]);
                if (t.style) {
                    let e = {};
            ...
            let t0 = (t) => (e, i) => {
                    let n = (0, a.useContext)(R),
                        r = (0, a.useContext)(L),
                        s = () =>
                            (function ({ scrapeMotionValuesFromProps: t, createRenderState: e, onMount: i }, n, r, s) {
                                let o = {
            ...
            let ev = "data-" + tz("framerAppearId"),
                ...
                eA = { waapi: () => Object.hasOwnProperty.call(Element.prototype, "animate") },
                eV = {},
                eS = {};
            ...
            let eM = eC(0.42, 0, 1, 1),
                ...
                eB = ej(eF),
                eO = eL(eB),
                eI = eC(0.33, 1.53, 0.69, 0.99),
                eN = ej(eI),
                eU = eL(eN),
                e$ = (t) => ((t *= 2) < 1 ? 0.5 * eN(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
                eW = { linear: el, easeIn: eM, easeInOut: eD, easeOut: ek, circIn: eF, circInOut: eO, circOut: eB, backIn: eN, backInOut: eU, backOut: eI, anticipate: e$ },
                ez = (t) => {
                    if (Array.isArray(t)) {
                ...
                e_ = (t, e, i) => (n) => {
                    ...
                    return { [t]: parseFloat(r), [e]: parseFloat(s), [i]: parseFloat(o), alpha: void 0 !== a ? parseFloat(a) : 1 };
                },
                eX = (t) => tc(0, 255, t),
                eY = { ...td, transform: (t) => Math.round(eX(t)) },
                eG = {
                    test: eH("rgb", "red"),
                ...
                eq = {
                    ...
                    parse: function (t) {
                        ...
                        return (
                            t.length > 5
                                ? ((e = t.substring(1, 3)), (i = t.substring(3, 5)), (n = t.substring(5, 7)), (r = t.substring(7, 9)))
                                : ((e = t.substring(1, 2)), (i = t.substring(2, 3)), (n = t.substring(3, 4)), (r = t.substring(4, 5)), (e += e), (i += i), (n += n), (r += r)),
                            { red: parseInt(e, 16), green: parseInt(i, 16), blue: parseInt(n, 16), alpha: r ? parseInt(r, 16) / 255 : 1 }
                        );
                    },
            ...
            let e3 = (t, e) => {
                ...
                e9 = { regex: /var\s*\(\s*--[\w-]+(\s*,\s*(?:(?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)+)?\s*\)/g, countKey: "Vars", token: "${v}", parse: el },
            ...
            function e7(t) {
                let e = t.toString(),
                    i = { value: e, tokenised: e, values: [], numVars: 0, numColors: 0, numNumbers: 0 };
            ...
            let ia = (t, e) => {
                ...
                iu = (t, e) => {
                    ...
                    return s
                        ? t7(ia(n.values, r.values), i)
                        : (el(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`),
                          is(t, e));
                },
                ih = (t, e, i) => {
                    let n = e - t;
            ...
            function iP({ keyframes: t, restDelta: e, restSpeed: i, ...n }) {
                ...
                let s = t[0],
                    ...
                    { stiffness: l, damping: u, mass: h, velocity: c, duration: d, isResolvedFromDuration: p } = (function (t) {
                        ...
                        if (!ix(t, iy) && ix(t, iv)) {
                            let i = (function ({ duration: t = 800, bounce: e = 0.25, velocity: i = 0, mass: n = 1 }) {
                                let r, s;
            ...
            function ib({ keyframes: t, velocity: e = 0, power: i = 0.8, timeConstant: n = 325, bounceDamping: r = 10, bounceStiffness: s = 500, modifyTarget: o, min: a, max: l, restDelta: u = 0.5, restSpeed: h }) {
                let c, d;
                let p = t[0],
                    m = { done: !1, value: p },
                ...
                let P = (t) => -v * Math.exp(-t / n),
                    ...
                    T = (t) => {
                        f(m.value) && ((c = t), (d = iP({ keyframes: [m.value, g(m.value)], velocity: im(b, t, m.value), damping: r, stiffness: s, restDelta: u, restSpeed: h })));
                    };
                return (
                    T(0),
                    {
            ...
            let iw = (t) => {
                ...
                return { start: () => b.update(e, !0), stop: () => w(e), now: () => (p.isProcessing ? p.timestamp : performance.now()) };
            };
            function iT(t) {
                let e = 0,
                    i = t.next(e);
            ...
            let iB = /([a-z-]*)\(.*?\)/g,
                ...
                iI = { ...tC, color: eK, backgroundColor: eK, outlineColor: eK, fill: eK, stroke: eK, borderColor: eK, borderTopColor: eK, borderRightColor: eK, borderBottomColor: eK, borderLeftColor: eK, filter: iO, WebkitFilter: iO },
                iN = (t) => iI[t];
            function iU(t, e) {
                let i = iN(t);
            ...
            let iH = (t, e, i, n = {}) => (r) => {
                ...
                let l = (function (t, e, i, n) {
                        ...
                        return ("none" === s && r && "string" == typeof i ? (s = iU(e, i)) : i$(s) && "string" == typeof i ? (s = iW(i)) : !Array.isArray(i) && i$(i) && "string" == typeof s && (i = iW(s)), Array.isArray(i))
                            ? (function (t, [...e]) {
                ...
                if (
                    ...
                    return (function ({ keyframes: t, delay: e, onUpdate: i, onComplete: n }) {
                        let r = () => (i && i(t[t.length - 1]), n && n(), { time: 0, speed: 1, duration: 0, play: el, pause: el, stop: el, then: (t) => (t(), Promise.resolve()), cancel: el, complete: el });
                ...
                if (e.owner && e.owner.current instanceof HTMLElement && !e.owner.getProps().onUpdate) {
                    let i = (function (t, e, { onUpdate: i, onComplete: n, ...r }) {
                        ...
                        let m = (function (t, e, i, { delay: n = 0, duration: r, repeat: s = 0, repeatType: o = "loop", ease: a, times: l } = {}) {
                                ...
                                return (
                                    Array.isArray(h) && (u.easing = h), t.animate(u, { delay: n, duration: r, easing: Array.isArray(h) ? "linear" : h, fill: "both", iterations: s + 1, direction: "reverse" === o ? "alternate" : "normal" })
                                );
                            })(t.owner.current, e, h, { ...r, duration: c, ease: d, times: p }),
                            f = () => m.cancel(),
                            g = () => {
                                b.update(f), s(), u();
                            };
            ...
            let iX = (t) => /^\-?\d*\.?\d+$/.test(t),
                iY = (t) => /^0[^.\s]+$/.test(t),
                iG = (t) => (e) => e.test(t),
                iq = [td, tT, tw, tb, tV, tA, { test: (t) => "auto" === t, parse: (t) => t }],
                iZ = (t) => iq.find(iG(t)),
                iK = [...iq, eK, ir],
                iJ = (t) => iK.find(iG(t));
                                  ...
                                  return (function (t, e, i = 0, n = 0, r = 1, s) {
                                      ...
                                      return (
                                          Array.from(t.variantChildren)
                                              .sort(i1)
                                              .forEach((t, n) => {
                                                  t.notify("AnimationStart", e), o.push(i0(t, e, { ...s, delay: i + l(n) }).then(() => t.notify("AnimationComplete", e)));
                                              }),
                                          Promise.all(o)
                                      );
                                  })(t, e, s + n, o, a, i);
                ...
                return {
                    ...
                    velocity: (function (t, e) {
                        ...
                        let i = t.length - 1,
                            n = null,
                            r = ne(t);
                        for (; i >= 0 && ((n = t[i]), !(r.timestamp - n.timestamp > ey(0.1))); ) i--;
                        if (!n) return { x: 0, y: 0 };
            ...
            class nj {
                ...
                start(t, { snapToCursor: e = !1 } = {}) {
                    ...
                    let n = (t) => {
                        ...
                        o = (t, e) => this.stop(t, e);
                    this.panSession = new i6(t, { onSessionStart: n, onStart: r, onMove: s, onSessionEnd: o }, { transformPagePoint: this.visualElement.getTransformPagePoint() });
                }
                stop(t, e) {
                ...
                resolveConstraints() {
                    ...
                    t && O(t)
                        ...
                        (this.elastic = (function (t = 0.35) {
                            return !1 === t ? (t = 0) : !0 === t && (t = 0.35), { x: nc(t, "left", "right"), y: nc(t, "top", "bottom") };
                        })(e)),
                        n !== this.constraints &&
                            i &&
                            this.constraints &&
                ...
                startAnimation(t) {
                    let { drag: e, dragMomentum: i, dragElastic: n, dragTransition: r, dragSnapToOrigin: s, onDragTransitionEnd: o } = this.getProps(),
                        ...
                        l = nv((o) => {
                            ...
                            let l = (a && a[o]) || {};
                            s && (l = { min: 0, max: 0 });
                            let u = { type: "inertia", velocity: i ? t[o] : 0, bounceStiffness: n ? 200 : 1e6, bounceDamping: n ? 40 : 1e7, timeConstant: 750, restDelta: 1, restSpeed: 10, ...r, ...l };
                ...
                getProps() {
                    let t = this.visualElement.getProps(),
                        { drag: e = !1, dragDirectionLock: i = !1, dragPropagation: n = !1, dragConstraints: r = !1, dragElastic: s = 0.35, dragMomentum: o = !0 } = t;
                    return { ...t, drag: e, dragDirectionLock: i, dragPropagation: n, dragConstraints: r, dragElastic: s, dragMomentum: o };
                }
            }
            function nF(t, e, i) {
            ...
            function nU(t) {
                let [e, i] = (function () {
                    ...
                    n = (0, a.useContext)(q);
                return a.createElement(nN, { ...t, layoutGroup: n, switchLayoutGroup: (0, a.useContext)(Z), isPresent: e, safeToRemove: i });
            }
            let n$ = {
                    borderRadius: { ...nI, applyTo: ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomLeftRadius", "borderBottomRightRadius"] },
            ...
            function rr({ attachResizeListener: t, defaultParent: e, measureScroll: i, checkIsScrollRoot: n, resetTransform: r }) {
                return class {
                    ...
                    mount(e, i = !1) {
                        ...
                        if (
                            ...
                            t(e, () => {
                                (this.root.updateBlockedByResize = !0),
                                    ...
                                    Y.hasAnimatedSinceResize && ((Y.hasAnimatedSinceResize = !1), this.nodes.forEach(rd));
                            });
                        }
                        n && this.root.registerSharedNode(n, this),
                            !1 !== this.options.animate &&
                                s &&
                                (n || r) &&
                                this.addEventListener("didUpdate", ({ delta: t, hasLayoutChanged: e, hasRelativeTargetChanged: i, layout: n }) => {
                    ...
                    didUpdate() {
                        ...
                        this.isUpdating &&
                            ((this.isUpdating = !1),
                            this.potentialNodes.size && (this.potentialNodes.forEach(rb), this.potentialNodes.clear()),
                    ...
                    updateScroll(t = "measure") {
                        ...
                        this.scroll && this.scroll.animationId === this.root.animationId && this.scroll.phase === t && (e = !1),
                            e && (this.scroll = { animationId: this.root.animationId, phase: t, isRoot: n(this.instance), offset: i(this.instance) });
                    }
                    resetTransform() {
                        if (!r) return;
                    ...
                    measure(t = !0) {
                        ...
                        return t && (n = this.removeTransform(n)), rw((e = n).x), rw(e.y), { animationId: this.root.animationId, measuredBox: i, layoutBox: n, latestValues: {}, source: this.id };
                    }
                    measurePageBox() {
                        let { visualElement: t } = this.options;
                        if (!t) return ng();
                    ...
                    applyTransform(t, e = !1) {
                        ...
                        for (let t = 0; t < this.path.length; t++) {
                            let n = this.path[t];
                            !e && n.options.layoutScroll && n.scroll && n !== n.root && nD(i, { x: -n.scroll.offset.x, y: -n.scroll.offset.y }), nb(n.latestValues) && nD(i, n.latestValues);
                        }
                    ...
                    resolveTargetDelta(t = !1) {
                        ...
                        if (this.layout && (l || u)) {
                            ...
                            if (this.relativeTarget || this.targetDelta) {
                                if (
                                    ((this.target || ((this.target = ng()), (this.targetWithTransforms = ng())), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target)
                                        ? (this.forceRelativeParentToResolveTarget(), (i = this.target), (n = this.relativeTarget), (r = this.relativeParent.target), no(i.x, n.x, r.x), no(i.y, n.y, r.y))
                                        : this.targetDelta
                                        ? (this.resumingFrom ? (this.target = this.applyTransform(this.layout.layoutBox)) : nK(this.target, this.layout.layoutBox), nV(this.target, this.targetDelta))
                                        : nK(this.target, this.layout.layoutBox),
                                    this.attemptToResolveRelativeTarget)
                                ) {
                                    this.attemptToResolveRelativeTarget = !1;
                                    let t = this.getClosestProjectingParent();
                                    t && !!t.resumingFrom == !!this.resumingFrom && !t.options.layoutScroll && t.target
                                        ? ((this.relativeParent = t),
                                          this.forceRelativeParentToResolveTarget(),
                                          (this.relativeTarget = ng()),
                                          (this.relativeTargetOrigin = ng()),
                    ...
                    calcProjection() {
                                ...
                                if (o) {
                                    ...
                                    for (let a = 0; a < o; a++) {
                                        ...
                                        (!o || !o.style || "contents" !== o.style.display) &&
                                            (n && r.options.layoutScroll && r.scroll && r !== r.root && nD(t, { x: -r.scroll.offset.x, y: -r.scroll.offset.y }),
                        ...
                        ns(this.projectionDelta, this.layoutCorrected, o, this.latestValues),
                            ...
                            (this.projectionTransform !== u || this.treeScale.x !== a || this.treeScale.y !== l) && ((this.hasProjected = !0), this.scheduleRender(), this.notifyListeners("projectionUpdate", o)),
                            ...
                            (this.mixTargetDelta = (e) => {
                                ...
                                rv(o.x, t.x, u),
                                    ...
                                    this.relativeTarget &&
                                        ...
                                        (nl(a, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
                                    ...
                                    h &&
                                        ...
                                        (function (t, e, i, n, r, s) {
                                            r
                                                ? ((t.opacity = eJ(0, void 0 !== i.opacity ? i.opacity : 1, nY(n))), (t.opacityExit = eJ(void 0 !== e.opacity ? e.opacity : 1, 0, nG(n))))
                                                : s && (t.opacity = eJ(void 0 !== e.opacity ? e.opacity : 1, void 0 !== i.opacity ? i.opacity : 1, n));
                                            for (let r = 0; r < nz; r++) {
                    ...
                    getProjectionStyles(t = {}) {
                        ...
                        if (!this.projectionDelta || !this.layout || !s.target) {
                            let e = {};
                            return (
                                this.options.layoutId && ((e.opacity = void 0 !== this.latestValues.opacity ? this.latestValues.opacity : 1), (e.pointerEvents = tQ(t.pointerEvents) || "")),
                                this.hasProjected && !nb(this.latestValues) && ((e.transform = r ? r({}, "") : "none"), (this.hasProjected = !1)),
                                e
                            );
                        }
                        ...
                        s.animationValues
                            ? (n.opacity = s === this ? (null !== (i = null !== (e = o.opacity) && void 0 !== e ? e : this.latestValues.opacity) && void 0 !== i ? i : 1) : this.preserveOpacity ? this.latestValues.opacity : o.opacityExit)
                            : (n.opacity = s === this ? (void 0 !== o.opacity ? o.opacity : "") : void 0 !== o.opacityExit ? o.opacityExit : 0),
                        tt)) {
            ...
            function ro(t) {
                ...
                if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
                    ...
                    t.notifyListeners("didUpdate", { layout: e, snapshot: i, delta: a, layoutDelta: o, hasLayoutChanged: l, hasRelativeTargetChanged: u });
                } else if (t.isLead()) {
            ...
            let rP = { duration: 0.45, ease: [0.4, 0, 0.1, 1] };
            function rb(t, e) {
                let i = t.root;
            ...
            function rT(t, e, i) {
                return "position" === t || ("preserve-aspect" === t && !nn(n4(e), n4(i), 0.2));
            }
            let rA = rr({
            ...
            let rM = new Set(["width", "height", "top", "left", "right", "bottom", "x", "y"]),
                ...
                rN = (t, e, i = {}, n = {}) => {
                        ...
                        (r.forEach((r) => {
                            ...
                            if (c !== l) {
                                if (rR(c) && rR(l)) {
                                    ...
                                    (null == c ? void 0 : c.transform) && (null == l ? void 0 : l.transform) && (0 === h || 0 === d)
                                        ? 0 === h
                                            ? u.set(l.transform(h))
                                            : (e[r] = c.transform(d))
                                        : (o ||
                        ...
                        return { target: e, transitionEnd: n };
                    {
                        ...
                        return (
                            ...
                            t.render(),
                            j && null !== i && window.scrollTo({ top: i }),
                ...
                rU = (t, e, i, n) => {
                    ...
                    return (e = o.target), (n = o.transitionEnd), (r = e), (s = n), rD(r) ? rN(t, r, i, s) : { target: r, transitionEnd: s };
                },
                r$ = { current: null },
                rW = { current: !1 },
                rz = new WeakMap(),
                ...
                update(t, e) {
                    ...
                    (this.prevMotionValues = (function (t, e, i) {
                        ...
                        for (let r in e) {
                            ...
                            else if (tr(o)) t.addValue(r, C(s, { owner: t })), i_(n) && n.remove(r);
                            else if (o !== s) {
                                if (t.hasValue(r)) {
                                    let e = t.getValue(r);
                            ...
                            if (o)
                                for (let a = 0; a < o; a++) {
                                    ...
                                    Array.isArray(l) && (u = l[0]),
                                        ...
                                        null != u &&
                                            ("string" == typeof u && (iX(u) || iY(u)) ? (u = parseFloat(u)) : !iJ(u) && ir.test(l) && (u = iU(o, l)),
                                            t.addValue(o, C(u, { owner: t })),
                                            void 0 === i[o] && (i[o] = u),
                ...
                rQ = {
                                    ...
                                    t.animationState ||
                                        (t.animationState = (function (t) {
                                            let e = (e) =>
                                                ...
                                                i = { animate: i3(!0), whileInView: i3(), whileHover: i3(), whileTap: i3(), whileDrag: i3(), whileFocus: i3(), exit: i3() },
                                                n = !0,
                                                r = (e, i) => {
                                                    let n = eg(t, i);
                                                    if (n) {
                                                ...
                                                for (let e = 0; e < i2; e++) {
                                                    ...
                                                    for (let t in V) {
                                                        let e = T[t],
                                                            i = A[t];
                                                        c.hasOwnProperty(t) ||
                                                            (e !== i ? (tZ(e) && tZ(i) ? (!ef(e, i) || P ? S(t) : (f.protectedKeys[t] = !0)) : void 0 !== e ? S(t) : h.add(t)) : void 0 !== e && h.has(t) ? S(t) : (f.protectedKeys[t] = !0));
                                                    }
                                                    (f.prevProp = g),
                                                        (f.prevResolvedValues = T),
                                                        f.isActive && (c = { ...c, ...T }),
                                                        n && t.blockInitialAnimation && (b = !1),
                                                        b && !x && u.push(...w.map((t) => ({ animation: t, options: { type: m, ...s } })));
                                                }
                                                if (h.size) {
                                                    let e = {};
                                                    h.forEach((i) => {
                        ...
                        Feature: class extends es {
                            ...
                            startObserver() {
                                ...
                                let { viewport: t = {} } = this.node.getProps(),
                                    ...
                                    s = { root: e ? e.current : void 0, rootMargin: i, threshold: "number" == typeof n ? n : em[n] },
                                    o = (t) => {
                    ...
                    focus: {
                        Feature: class extends es {
                            ...
                            mount() {
                                this.unmount = t7(
                                    t2(this.node.current, "focus", () => this.onFocus()),
                                    t2(this.node.current, "blur", () => this.onBlur())
                                );
                            }
                            unmount() {}
                        },
                            ...
                            let s = (0, a.forwardRef)(function (s, o) {
                                ...
                                if (!d && j) {
                                    p.visualElement = (function (t, e, i, n) {
                                        let { visualElement: r } = (0, a.useContext)(R),
                                            s = (0, a.useContext)(B),
                                            o = (0, a.useContext)(L),
                                            l = (0, a.useContext)(M).reducedMotion,
                                            u = (0, a.useRef)();
                                        (n = n || s.renderer), !u.current && n && (u.current = n(t, { visualState: e, parent: r, props: i, presenceContext: o, blockInitialAnimation: !!o && !1 === o.initial, reducedMotionConfig: l }));
                                        let h = u.current;
                                ...
                                return a.createElement(
                                    R.Provider,
                                    { value: p },
                                    h && p.visualElement ? a.createElement(h, { visualElement: p.visualElement, ...c }) : null,
                                    i(
                                        r,
                                        s,
                                        m,
                    ...
                    children: [
                        (0, r.jsxs)(r.Fragment, {
                            children: [
                                ...
                                (0, r.jsx)(c(), { strategy: "afterInteractive", src: "https://www.googletagmanager.com/gtag/js?id=".concat(r1) }),
                            ],
                        }),
                        (0, r.jsxs)("div", {
                                ...
                                (0, r.jsxs)("div", {
                                    ...
                                    children: [
                                        (0, r.jsx)("a", {
                                            href: "#content",
                                            className:
                                                "absolute left-0 top-0 block -translate-x-full rounded bg-gradient-to-br from-teal-400 via-blue-500 to-purple-600 px-4 py-3 text-sm font-bold uppercase tracking-widest text-white focus-visible:translate-x-0",
        ...
        7952: function () {},
        6364: function (t) {
            t.exports = { style: { fontFamily: "'__inter_20b187', '__inter_Fallback_20b187'" }, className: "__className_20b187", variable: "__variable_20b187" };
        },
        9008: function (t, e, i) {
            t.exports = i(2636);
        },
